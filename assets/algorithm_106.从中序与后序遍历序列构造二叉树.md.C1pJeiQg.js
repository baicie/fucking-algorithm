import{_ as i,c as a,o as n,a7 as p}from"./chunks/framework.Ed-g3oaB.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/106.从中序与后序遍历序列构造二叉树.md","filePath":"algorithm/106.从中序与后序遍历序列构造二叉树.md","lastUpdated":1745231817000}'),l={name:"algorithm/106.从中序与后序遍历序列构造二叉树.md"};function h(k,s,t,e,r,E){return n(),a("div",null,s[0]||(s[0]=[p(`<div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">        /*</span></span>
