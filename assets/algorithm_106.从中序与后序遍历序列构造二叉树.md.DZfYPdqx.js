import{_ as s,c as i,o as a,a7 as n}from"./chunks/framework.Bgb21v0T.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/106.从中序与后序遍历序列构造二叉树.md","filePath":"algorithm/106.从中序与后序遍历序列构造二叉树.md","lastUpdated":null}'),p={name:"algorithm/106.从中序与后序遍历序列构造二叉树.md"},l=n(`<div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">        /*</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    \`\`\`</span></span></code></pre></div>`,1),h=[l];function k(t,e,r,E,d,g){return a(),i("div",null,h)}const A=s(p,[["render",k]]);export{c as __pageData,A as default};
