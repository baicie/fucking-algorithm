import{_ as s,c as i,o as a,a7 as n}from"./chunks/framework.Bgb21v0T.js";const o=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/235.二叉搜索树的最近公共祖先.md","filePath":"algorithm/235.二叉搜索树的最近公共祖先.md","lastUpdated":null}'),l={name:"algorithm/235.二叉搜索树的最近公共祖先.md"},p=n(`<div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">        /*</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    \`\`\`</span></span></code></pre></div>`,1),t=[p];function h(k,e,r,d,E,g){return a(),i("div",null,t)}const y=s(l,[["render",h]]);export{o as __pageData,y as default};
